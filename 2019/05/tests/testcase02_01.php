...
$fixtures = [
    ...
    '3,9,7,9,10,9,4,9,99,-1,8'                 => [2 => 1, 6 => 1, 8 => 0, 22 => 0, 0 => 0],
    '3,3,1108,-1,8,3,4,3,99'                   => [2 => 0, 6 => 1, 8 => 0, 22 => 0, 0 => 0],
    '3,3,1107,-1,8,3,4,3,99'                   => [2 => 1, 6 => 1, 8 => 0, 22 => 0, 0 => 0],
...
foreach ($fixtures as $program => $tests) {
    ...
    foreach ($tests as $input => $expected) {
        ...
        if (assert($expected === $result, sprintf('Test #%d: Expected: %s, Result: %s', $progNum, $expected, $result))) {
